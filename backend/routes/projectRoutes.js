...
router.post('/enhance-description', protect, (req, res) => enhanceDescription(req, res, req.io));
router.get('/myprojects', protect, (req, res) => getMyProjects(req, res, req.io)); // Ensure this route is before the dynamic :id route
...
router.post('/:id/comment', protect, (req, res) => commentProject(req, res, req.io));
router.post('/:id/follow', protect, (req, res) => followProject(req, res, req.io));
