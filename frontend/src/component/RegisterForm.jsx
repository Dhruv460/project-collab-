...
const RegisterForm = () => {
  ...
  return (
    <Box position="relative" minH="100vh" overflow="hidden" bg={theme === 'dark' ? 'gray.900' : 'gray.100'}>
      ...
      <Center position="relative" zIndex={1} minH="100vh" p={6}>
        <Box maxW="md" w="full" bg={theme === 'dark' ? 'gray.800' : 'white'} shadow="md" rounded="lg" p={6}>
          <Heading as="h2" size="lg" textAlign="center" mb={6} color={theme === 'dark' ? 'gray.100' : 'gray.900'}>
            Sign up for an account
          </Heading>
          <form onSubmit={handleSubmit}>
            <VStack spacing={4}>
              <FormControl id="username" isRequired>
                <FormLabel color={theme === 'dark' ? 'gray.300' : 'gray.700'}>Username</FormLabel>
                <Input
                  type="text"
                  name="username"
              ...
              <FormControl id="email" isRequired>
                <FormLabel color={theme === 'dark' ? 'gray.300' : 'gray.700'}>Email</FormLabel>
                <Input
              ...
              <FormControl id="password" isRequired>
                <FormLabel color={theme === 'dark' ? 'gray.300' : 'gray.700'}>Password</FormLabel>
                <Input
                  type="password"
                  name="password"
              ...
              <FormControl id="profileImage" isRequired>
                <FormLabel color={theme === 'dark' ? 'gray.300' : 'gray.700'}>Profile Image</FormLabel>
                <Input
                  type="file"
                  name="profileImage"
                  onChange={handleChange}
          ...
          <Text mt={4} textAlign="center" color={theme === 'dark' ? 'gray.400' : 'gray.600'}>
